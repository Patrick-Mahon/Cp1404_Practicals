...
almost_numbers = [int(i) for i in almost_numbers]
print(almost_numbers)


lowercase_full_names = ["Bob Martin", "Angel Harlem", "Jimi Hendrix", "Alan Turing",
              "Ada Lovelace"]
lowercase_full_names = [i.lower() for i in lowercase_full_names]
